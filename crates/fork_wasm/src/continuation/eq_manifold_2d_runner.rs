//! Stepped runner wrapper for 2D equilibrium manifolds.

use fork_core::continuation::{
    continue_manifold_eq_2d, ContinuationBranch, Manifold2DSettings, ManifoldGeometry, StepResult,
};
...
#[wasm_bindgen]
pub struct WasmEqManifold2DRunner {
    progress: StepResult,
    result: Option<ContinuationBranch>,
}

#[wasm_bindgen]
impl WasmEqManifold2DRunner {
    ...
    ) -> Result<WasmEqManifold2DRunner, JsValue> {
