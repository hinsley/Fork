...
export class WasmTransferEigenmodeRunner {
  ...
  get_result(): any;
  get_progress(): any;
  constructor(column_offsets: Uint32Array, target_indices: Uint32Array, probabilities: Float64Array, stationary_distribution: Float64Array, stationary_eigenvalue: number, stationary_residual: number, requested_modes: number, tolerance: number, max_restarts: number, warm_start_real: Float64Array, warm_start_imaginary: Float64Array);
  run_steps(batch_size: number): any;
}
...
export interface InitOutput {
  ...
  readonly __wbg_wasmtransfereigenmoderunner_free: (a: number, b: number) => void;
  ...
  readonly wasmtransfereigenmoderunner_get_progress: (a: number) => [number, number, number];
  readonly wasmtransfereigenmoderunner_get_result: (a: number) => [number, number, number];
  readonly wasmtransfereigenmoderunner_new: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number, l: number, m: number, n: number, o: number, p: number, q: number) => [number, number, number];
  readonly wasmtransfereigenmoderunner_run_steps: (a: number, b: number) => [number, number, number];
