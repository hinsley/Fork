...
export class WasmTransferOperatorRunner {
  ...
  get_result(): any;
  get_progress(): any;
  constructor(equations: string[], params: Float64Array, param_names: string[], var_names: string[], minimums: Float64Array, maximums: Float64Array, resolution: Uint32Array, samples_per_cell: number, iterations: number, max_stationary_iterations: number, tolerance: number);
  run_steps(_batch_size: number): any;
}
...
export interface InitOutput {
  ...
  readonly wasmtransferoperatorrunner_new: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number, l: number, m: number, n: number, o: number, p: number, q: number, r: number) => [number, number, number];
