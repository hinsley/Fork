...
impl Zero for Dual {
    ...
    fn is_zero(&self) -> bool { self.val == 0.0 && self.eps == 0.0 }
}
...
impl Add for Dual {
    type Output = Self;
    fn add(self, rhs: Self) -> Self { Self::new(self.val + rhs.val, self.eps + rhs.eps) }
}

impl Sub for Dual {
    type Output = Self;
    fn sub(self, rhs: Self) -> Self { Self::new(self.val - rhs.val, self.eps - rhs.eps) }
}
...
impl Div for Dual {
    ...
    fn div(self, rhs: Self) -> Self {
        ...
        Self::new(self.val / rhs.val, (self.eps * rhs.val - self.val * rhs.eps) / denom)
    }
}

impl Neg for Dual {
    type Output = Self;
    fn neg(self) -> Self { Self::new(-self.val, -self.eps) }
}
...
impl AddAssign for Dual { fn add_assign(&mut self, rhs: Self) { *self = *self + rhs; } }
impl SubAssign for Dual { fn sub_assign(&mut self, rhs: Self) { *self = *self - rhs; } }
impl MulAssign for Dual { fn mul_assign(&mut self, rhs: Self) { *self = *self * rhs; } }
impl DivAssign for Dual { fn div_assign(&mut self, rhs: Self) { *self = *self / rhs; } }
impl RemAssign for Dual { fn rem_assign(&mut self, rhs: Self) { *self = *self % rhs; } }

impl Num for Dual {
    type FromStrRadixErr = ();
    fn from_str_radix(str: &str, radix: u32) -> Result<Self, Self::FromStrRadixErr> {
        f64::from_str_radix(str, radix).map(|v| Self::new(v, 0.0)).map_err(|_| ())
    }
}
...
impl ToPrimitive for Dual {
    ...
    fn to_f64(&self) -> Option<f64> { Some(self.val) }
}

impl FromPrimitive for Dual {
    fn from_i64(n: i64) -> Option<Self> { Some(Self::new(n as f64, 0.0)) }
    fn from_u64(n: u64) -> Option<Self> { Some(Self::new(n as f64, 0.0)) }
    fn from_f64(n: f64) -> Option<Self> { Some(Self::new(n, 0.0)) }
}
...
impl Float for Dual {
    fn nan() -> Self { Self::new(f64::NAN, 0.0) }
    fn infinity() -> Self { Self::new(f64::INFINITY, 0.0) }
    fn neg_infinity() -> Self { Self::new(f64::NEG_INFINITY, 0.0) }
    fn neg_zero() -> Self { Self::new(-0.0, -0.0) }
    fn min_value() -> Self { Self::new(f64::MIN, 0.0) }
    fn min_positive_value() -> Self { Self::new(f64::MIN_POSITIVE, 0.0) }
    fn max_value() -> Self { Self::new(f64::MAX, 0.0) }
    ...
    fn floor(self) -> Self { Self::new(self.val.floor(), 0.0) }
    fn ceil(self) -> Self { Self::new(self.val.ceil(), 0.0) }
    fn round(self) -> Self { Self::new(self.val.round(), 0.0) }
    fn trunc(self) -> Self { Self::new(self.val.trunc(), 0.0) }
    fn fract(self) -> Self { Self::new(self.val.fract(), self.eps) }
    fn abs(self) -> Self { 
        Self::new(self.val.abs(), if self.val >= 0.0 { self.eps } else { -self.eps })
    }
    fn signum(self) -> Self { Self::new(self.val.signum(), 0.0) }
    ...
    fn exp2(self) -> Self { unimplemented!() }
    fn ln(self) -> Self {
        Self::new(self.val.ln(), self.eps / self.val)
    }
    fn log(self, base: Self) -> Self { self.ln() / base.ln() }
    fn log2(self) -> Self { unimplemented!() }
    fn log10(self) -> Self { unimplemented!() }
    ...
    fn abs_sub(self, _other: Self) -> Self { unimplemented!() }
    
    fn cbrt(self) -> Self { unimplemented!() }
    fn hypot(self, _other: Self) -> Self { unimplemented!() }
    ...
    fn asin(self) -> Self { unimplemented!() }
    fn acos(self) -> Self { unimplemented!() }
    fn atan(self) -> Self { unimplemented!() }
    fn atan2(self, _other: Self) -> Self { unimplemented!() }
    fn sin_cos(self) -> (Self, Self) { (self.sin(), self.cos()) }
    
    fn exp_m1(self) -> Self { unimplemented!() }
    fn ln_1p(self) -> Self { unimplemented!() }
    fn sinh(self) -> Self { unimplemented!() }
    fn cosh(self) -> Self { unimplemented!() }
    fn tanh(self) -> Self { unimplemented!() }
    fn asinh(self) -> Self { unimplemented!() }
    fn acosh(self) -> Self { unimplemented!() }
    fn atanh(self) -> Self { unimplemented!() }
...
where S: DynamicalSystem<f64> + DynamicalSystem<Dual> 
{
