...
| Genuine two-saddle heteroclinic | Not implemented | Supported beyond strict parity with adaptive orthogonal collocation (default), standard single/multiple shooting, restart, and extension; connection-specific events remain a follow-up |
